...
# Version: 0.12
# yum -y update && curl -O https://raw.githubusercontent.com/khaledalhashem/nginx_custom/master/nginx_custom_centos.sh && chmod 0700 ngx_pagespeed.sh && bash -x ngx_pagespeed.sh 2>&1 | tee nginx_custom.log
